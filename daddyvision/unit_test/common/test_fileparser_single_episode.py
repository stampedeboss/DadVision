...
class KnownValues(unittest.TestCase):
    File_SxxExx = {}
    File_SxxExx['FileName'] = "/mnt/TV/Series/Covert Affairs/Season 1/E01 Pilot.mkv"
...
# Season #/E##
    def test_FileParser_single_case_001(self):
        KnownValues.File_SxxExx["FileName"] = "/mnt/TV/Series/Covert Affairs/Season 1/E01 Case 001.ext"
    ...
    def test_FileParser_single_case_002(self):
        KnownValues.File_SxxExx["FileName"] = "/mnt/TV/Series/Covert Affairs/Season 01/E01 Case 002.ext"
        self.assertEqual(self.parser.getFileDetails(KnownValues.File_SxxExx["FileName"]), KnownValues.File_SxxExx)

    def test_FileParser_single_case_003(self):
        KnownValues.File_SxxExx["FileName"] = "/mnt/TV/Series/Covert Affairs/Season 1/E001 Case 003.ext"
        self.assertEqual(self.parser.getFileDetails(KnownValues.File_SxxExx["FileName"]), KnownValues.File_SxxExx)

    def test_FileParser_single_case_004(self):
        KnownValues.File_SxxExx["FileName"] = "/mnt/TV/Series/Covert Affairs/Season 01/E001 Case 004.ext"
        self.assertEqual(self.parser.getFileDetails(KnownValues.File_SxxExx["FileName"]), KnownValues.File_SxxExx)
