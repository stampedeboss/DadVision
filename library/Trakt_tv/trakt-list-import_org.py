...
PASSWORD = hashlib.sha1('0husKi3s').hexdigest()
...
def send_data(imdb_id_data):
    ...
    print json_data
    if watchlist == 1:
        req = urllib2.Request("https://api.trakt.tv/movie/unwatchlist/"+APIKEY, json_data, {'Content-Type': 'application/json', 'Content-Length': clen})
    else:
